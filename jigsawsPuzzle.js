...
const startPuzzle = (event, shuffledImages) => {
  srcImgId = event.target.id;
  desImgId = shuffledImages.indexOf('white.jpg') + 1;
  console.log(srcImgId, desImgId);
...
window.onload = () => {
  ...
  document.addEventListener('click', () => startPuzzle(event, shuffledImages));
};